...
function checkAnswer(num) {
    ...
    if (correct) {
        check.value = null;
        check.placeholder = "Correct!" + " " + check.name;
        check.style.border = "2px solid #89e219";
    } else {
        check.value = null;
        check.placeholder = "Incorrect!" + " " + check.name;
...
function buildTable() {
    ...
    list.forEach((word, idx) => {
        ...
        (function() {
            var some_id = document.getElementById(`check${idx}`);
            some_id.type = 'text';
